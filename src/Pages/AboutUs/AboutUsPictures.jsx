        ...
        <div className='about-container container'>
          <div className='about-top-wrap'>
            <ul className='about-top-list list'>
              ...
              <li className='about-top-item'>
                <p className='about-top-text text'>
                  В Україну приїхав декілька років тому і відвідав Одесу. Краса міста та неповторний колорит оселились у серці Кості. Бажаючи дарувати радість людям, Костя залишився в Одесі з бажанням годувати українців смачною їжею
                </p>
              </li>
              <li className='about-top-item'>
                <p className='about-top-text text'>
