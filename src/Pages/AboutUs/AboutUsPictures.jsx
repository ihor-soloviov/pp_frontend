        ...
        <div className='about-container container'>
          <div className='about-top-wrap'>
            <ul className='about-top-list list'>
              ...
              <li className='about-top-item'>
                <p className='about-top-text text'>
                  Спостерігаючи за популярністю піци, суші, бургерів та шаурми, Костя запитав себе: <b>чому домашня їжа, не займає належного місця на ринку доставки?</b>
                </p>
              </li>
              <li className='about-top-item'>
                <p className='about-top-text text'>
                  Так була народжена ідея Polar. Було вирішено створити сервіс, де кожен зможе насолодитися пельменями з різними начинками. Начинки для пельменів ми підбирали, надихнувшись кухнями інших країн, а якісні соуси мають приголомшити вас своїм різноманіттям.
                </p>
              </li>

              <li className='about-top-item'>
                <p className='about-top-text text'>
                  Polar відкриває для українців і гостей країни нові гастрономічні горизонти, сприяючи культурному обміну та економічному розвитку.
                </p>
              </li>
            </ul>
          ...
          <div className='about-wrap'>
            ...
            <LazyLoadImage effect="blur" src={img02} alt='dishes' className='about-img second' />
          </div>
