  ...
  return (
    <section className='order-page__section'>
      ...
      <section
        ...
        className='order-page__section-inputs order-page__section-inputs-row'
      >
        <div className='order-page__block'>
          <span>Кількість персон:</span>
          <Checkbox
            isChecked={withoutDevices}
            onCheckboxChange={() => handleFormValueChange('withoutDevices', !withoutDevices)}
            label={'Без приборів'}
          />
        </div>
        <div className='order-page__block'>
          ...
          <div className='counter'>
            ...
            <div
              className='counter__btn'
              onClick={() => handleFormValueChange('personCount', personCount + 1)}
            >
              +
            </div>
          </div>
      ...
      <section className='order-page__section-inputs'>
        <div className='order-page__block'>
          <Checkbox
            isChecked={doNotCall}
            onCheckboxChange={() => handleFormValueChange('doNotCall', !doNotCall)}
